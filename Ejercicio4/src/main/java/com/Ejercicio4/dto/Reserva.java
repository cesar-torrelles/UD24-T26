...
public class Reserva {
	...
	@ManyToOne
	@JoinColumn(name = "investigadores_id")//busca ultimo valor e incrementa desde id final de db
	private Investigadores investigadores;
	
	 @ManyToOne
	@JoinColumn(name = "equipos_id")//busca ultimo valor e incrementa desde id final de db
